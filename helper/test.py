...
# # Extract and print printer names
...
#         printer_name = printer[2]  # The printer name is the third element in the tuple
#         print(printer_name)

# # Call the function to list printers
# list_printers()
...
#         print(f"Sent {pdf_path} to print.")
#     except Exception as e:
#         print(f"Error occurred while printing: {e}")


# # Usage
# # pdf_path = r"C:\Users\homelab\Documents\rmsbe\helper\bill_pdfs\f7ebc68b-97b2-4ad9-a697-ae5cbbdb3582.pdf"
# pdf_path = 'C:\\Users\\homelab\\Documents\\rmsbe\\helper\\bill_pdfs\\f7ebc68b-97b2-4ad9-a697-ae5cbbdb3582.pdf'
